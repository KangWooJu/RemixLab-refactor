...
public enum BaseExceptionEnum implements MessageCommInterface {
    ...
    USER_ALREADY_LOGIN("BASE.EXCEPTION.USER_ALREADY_LOGIN","이미 로그인된 회원입니다."),
    REFRESH_TOKEN_NOT_FOUND("BASE.EXCEPTION.REFRESH_TOKEN_NOT_FOUND","회원의 refresh 토큰을 찾을 수 없습니다."),
